...
<div class="max-w-7xl mx-auto mt-16">
    ...
    <div class="flex items-center justify-between">
        <h1 class="text-xl capitalize font-semibold">My Campaigns</h1>
        <div class="flex items-center gap-5 text-sm">
            <button class=" py-2 px-5 capitalize border rounded"
    ...
    <div class="grid grid-cols-4 gap-5 mt-10">
        ...
        @empty
            <div class="col-span-4 my-24 text-center">
                <p class="text-xl">No Campaign Yet</p>
                <a class="p-3 text-green-500 hover:underline inline-block" href="{{route('donations.create')}}">Create New Campaign</a>
            </div>
        @endforelse
